...
try:
    from local_connection_data import MYSQL_TEST_CONNECTION_STRING as TEST_CONNECTION_STRING
except ImportError:
    pass

EXISTING_CONNECTION_STRING = 'mysql://portfolio:portfolio@localhost/portfolio'
try:
    from local_connection_data import MYSQL_EXISTING_CONNECTION_STRING as EXISTING_CONNECTION_STRING
except ImportError:
    pass
...
class TestTableAndIndexFromDb(TestTableAndIndexParent):
    ...
    def test_get_index_from_db(self):
        ...
        self.table = Table(self.table_name, self.cursor)
        assert self.index_name in list(self.table.indexes.keys())
...
class TestTableAndIndexMethods(TestTableAndIndexParent):
    ...
    def test_to_xml_ind1(self):
        ...
        print(list(self.table.indexes.items()))
